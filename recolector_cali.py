...
def save_failed_article(article_data, error_msg):
    filename = 'articulos_fallidos_cali.json'
    failed_articles = []
...
def collect_news(filename):
    ...
    search_terms = [
        '"riña" "Cali"', '"pelea" "Cali"', '"altercado" "Cali"',
        'site:elpais.com.co "riña"', 'site:90minutos.co "riña"', 'site:tubarco.news "riña"',
        '"herido en riña" "Cali"', '"muerto en riña" "Cali"', '"enfrentamiento" "Cali"'
    ]
    keywords = [
...
if __name__ == "__main__":
    ...
    print("iniciando recoleción Cali...")
    filename = 'noticias_cali_2026_ene_abril7.json'
